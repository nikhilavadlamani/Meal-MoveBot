...
const Chatgpt = () => {
  ...
  const handleYogaClick = () => {
    navigate('/ProfileSetup');  // Navigates to the profile page
  };
    ...
    <div className='body'>
      ...
      <header className="header">
        ...
        <div className="button-container">
          <button onClick={handleYogaClick} className="button">Back</button>
      ...
      {/* Chatbot iframe */}
      <iframe
        src="http://localhost:5000/"  // URL where your Flask app serves the HTML
        title="Chatbot"
      />
    </div>
  );
